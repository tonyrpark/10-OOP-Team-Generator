...
<link href="https://fonts.googleapis.com/css2?family=DotGothic16&family=Montserrat&family=Poppins:ital@1&family=Roboto&family=Ubuntu&display=swap" rel="stylesheet">
...
function makeManagerCard(x) {
  ...
  let mangerCard = `
    ...
    <div class="card cardbody">
      <div class="card-header" style="background: #276678">
                   ${x.name}<br>
...
function makeEngineerCard(x) {
  let engineerCard = `
        ...
        <div class="col-md-3">
                    <div class="card cardbody">
                      <div class="card-header" style="background: #1687a7">
                                   ${x.name}<br>
